    ...
    class Program {
        ...
        private static void Exercise1_1() {
            using (var db = new BooksDbContext()) {
                ...
                {
                    Birthday = new DateTime(1899, 6, 14),//ここから
                    Gender = "M",
                    Name = "川端康成",
                };
        ...
        private static void Exercise1_2() {
            using (var db = new BooksDbContext()) {
                foreach (var item in db.Books.Include(nameof(Author)).ToList()) {
                    Console.WriteLine("{0} {1} {2}", item.Title, item.PublishedYear, item.Author.Name);
                }
            }
        }
        ...
        private static void Exercise1_3() {
            using (var db = new BooksDbContext()) {
                foreach (var item in db.Books.Where(b => b.Title.Length == db.Books.Max(m => m.Title.Length))) {
        ...
        private static void Exercise1_4() {
            using (var db = new BooksDbContext()) {
                foreach (var item in db.Books.OrderBy(b => b.PublishedYear).Take(3).Include(nameof(Author))) {
